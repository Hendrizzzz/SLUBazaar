...
<body>
    ...
    <nav class="sidebar">
        <div class="nav-icons">
            ...
            <a href="index.php?action=chat" class="active" title="Messages"><i
    ...
    <div class="main-wrapper">
        ...
        <div class="chat-container">
            ...
            <main class="chat-window">
                ...
                <div id="emptyState"
                    style="height: 100%; display: flex; align-items: center; justify-content: center; flex-direction: column; color: #888;">
