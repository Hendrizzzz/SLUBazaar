...
<body>
    ...
    <nav class="sidebar">
        ...
        <div class="bottom-user">
            <img src="https://ui-avatars.com/api/?name=<?php echo urlencode($user->getFirstName()); ?>&background=random"
                alt="Me">
        </div>
    </nav>
            ...
            <div class="profile-header">
                <div class="user-info">
                    <div class="profile-img-wrapper">
                        <img src="https://ui-avatars.com/api/?name=<?php echo urlencode($user->getFirstName() . ' ' . $user->getLastName()); ?>&size=128&background=333&color=fff"
                            alt="Profile Pic">
                    </div>
                    <div class="user-text">
    ...
    <div class="modal" id="rate-modal">
        <div class="modal-content"
            style="height: auto; max-width: 500px; padding: 0; display:flex; flex-direction:column;">
            ...
            <div style="padding: 30px; width: 100%; text-align:center;">
                ...
                <form id="rating-form" onsubmit="event.preventDefault(); submitRating();">
                    ...
                    <div class="star-rating-input"
                        style="font-size: 2.5rem; color: #cbd5e1; cursor: pointer; margin-bottom: 25px; display:flex; gap:15px; justify-content:center;">
                    ...
                    <button type="submit" class="btn-sold-action"
                        style="background:var(--primary); color:white; width:100%; padding:12px; font-size:1.1rem;">Submit
                        Rating</button>
                </form>
            </div>
        </div>
    ...
    <div class="modal" id="verify-modal">
        <div class="modal-content"
            style="height: auto; max-width: 400px; padding: 0; display:flex; flex-direction:column;">
            <button class="close-btn" style="top:10px; right:15px;" onclick="closeVerifyModal()">&times;</button>
            <div style="padding: 30px; width: 100%; text-align:center;">
                <div
                    style="background:#eff6ff; width:60px; height:60px; border-radius:50%; display:flex; align-items:center; justify-content:center; margin:0 auto 20px;">
                ...
                <form id="verify-form" onsubmit="event.preventDefault(); submitVerification();">
                    ...
                    <button type="submit" class="btn-sold-action"
                        style="background:var(--primary); color:white; width:100%; padding:12px; font-size:1.1rem;">Verify
                        & Complete</button>
                </form>
            </div>
        </div>
    ...
    <div class="modal" id="edit-profile-modal">
        <div class="modal-content"
            style="height: auto; max-width: 500px; padding: 0; display:flex; flex-direction:column;">
            <button class="close-btn" style="top:10px; right:15px;" onclick="closeEditProfileModal()">&times;</button>
            <div style="padding: 30px; width: 100%;">
                <h2 style="font-family:'Lalezar'; margin-bottom:10px; color:var(--text-dark); text-align:center;">Edit
                    Profile</h2>
                <p style="color:#64748b; margin-bottom:25px; text-align:center;">Update your personal information</p>

                <form id="edit-profile-form" onsubmit="event.preventDefault(); submitProfileUpdate();">
                    <div style="display:flex; gap:15px; margin-bottom:15px;">
                        <div class="form-group" style="flex:1;">
                            <label for="edit-fname"
                                style="font-size:0.9rem; font-weight:600; color:#334155; margin-bottom:5px; display:block;">First
                                Name</label>
                            <input type="text" id="edit-fname" name="fname"
                                value="<?php echo htmlspecialchars($user->getFirstName()); ?>" required
                                style="width:100%; padding:10px; border:1px solid #cbd5e1; border-radius:8px;">
                        </div>
                        <div class="form-group" style="flex:1;">
                            <label for="edit-lname"
                                style="font-size:0.9rem; font-weight:600; color:#334155; margin-bottom:5px; display:block;">Last
                                Name</label>
                            <input type="text" id="edit-lname" name="lname"
                    ...
                    <p style="font-size:0.85rem; color:#64748b; margin-bottom:15px;">Change Password (Optional)</p>

                    <div class="form-group" style="margin-bottom:15px;">
                        <input type="password" id="edit-current-password" name="current_password"
                            placeholder="Current Password (Required to save changes)" required
                            style="width:100%; padding:10px; border:1px solid #cbd5e1; border-radius:8px; background:#f8fafc;">
                    </div>

                    <div class="form-group" style="margin-bottom:15px;">
                        <input type="password" id="edit-new-password" name="new_password" placeholder="New Password"
                            style="width:100%; padding:10px; border:1px solid #cbd5e1; border-radius:8px;">
                    </div>
                    ...
                    <button type="submit" class="btn-sold-action"
                        style="background:var(--primary); color:white; width:100%; padding:12px; font-size:1.1rem;">Save
                        Changes</button>
                </form>
            </div>
        </div>
